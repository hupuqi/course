		...
		<div id="sidebar" class="menu-min">
				...
				<ul class="nav nav-list">
					...
					<c:if test="${userType==3}">
						<li id="zxsgl">
						  <a onclick="siMenu('zxsgl','lmxsgl','学生管理','student/list.do')"><i class="icon-double-angle-right"></i><span>学生管理</span></a>
						</li>
						<li id="zjsgl">
						  <a onclick="siMenu('zjsgl','lmjsgl','教师管理','teacher/list.do')"><i class="icon-double-angle-right"></i><span>教师管理</span></a>
						</li>
						<li id="zkcgl">
						  <a onclick="siMenu('zkcgl','lmkcgl','课程管理','course/list.do')"><i class="icon-double-angle-right"></i><span>课程管理</span></a>
						</li>
						<li id="zglygl">
						  <a onclick="siMenu('zglygl','lmglygl','管理员管理','administrator/list.do')"><i class="icon-double-angle-right"></i><span>管理员管理</span></a>
						</li>
						<li id="zgjxlgl">
						  <a onclick="siMenu('zgjxlgl','lmjxlgl','教学楼管理','teachingbuilding/list.do')"><i class="icon-double-angle-right"></i><span>教学楼管理</span></a>
						</li>
					</c:if>
